...
const Navbar = ({ startDate, endDate, setStartDate, setEndDate, setCSAName }) => {
  ...
  const handleEndDateChange = (e) => {
    ...
    const minDate = "2021-08-18"; // Set your desired minimum date here

    // Check if the selected date is outside the valid range
    if (selectedDate > maxDate || selectedDate < minDate) {
      alert("Please select a date within the valid range."); // Display an alert message
    } else {
      ...
      <div className="wrapper">
        ...
        <div className="right">
          ...
          <input
            ...
            className="end"
            value={endDate}
            min="2021-08-18" // Set the minimum date value
            max="2021-12-31" // Set the maximum date value
